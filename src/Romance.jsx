...
const Romance = () => {
    ...
    useEffect(() => {
       axios.get(`${baseURL}/discover/movie?api_key=${API_KEY}&with_genres=10749`).then((response) => {
    ...
    return (
        <div className="h-screen w-screen bg-black overflow-x-hidden">
            <Navbar/>
            <div className="flex justify-center mt-5 text-5xl"><h1 className="text-white">Romance</h1></div>
