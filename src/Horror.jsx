...
const Horror = () => {
    ...
    useEffect(() => {
       axios.get(`${baseURL}/discover/movie?api_key=${API_KEY}&with_genres=27`).then((response) => {
    ...
    return (
        <div className="h-screen w-screen bg-black overflow-x-hidden">
            <Navbar/>
            <div className="flex justify-center mt-5 text-5xl"><h1 className="text-white">Horror</h1></div>
