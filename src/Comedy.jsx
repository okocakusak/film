...
const Comedy = () => {
    ...
    useEffect(() => {
       axios.get(`${baseURL}/discover/movie?api_key=${API_KEY}&with_genres=35`).then((response) => {
    ...
    return (
        <div className="h-screen w-screen bg-black overflow-x-hidden">
            <Navbar/>
            <div className="flex justify-center my-5 text-5xl"><h1 className="text-white">Comedy</h1></div>
