...
const TopRated = () => {
    ...
    useEffect(() => {
       axios.get(`${baseURL}/movie/top_rated?api_key=${API_KEY}&language=en-US`).then((response) => {
    ...
    return (
        <div className="h-screen w-screen bg-black overflow-x-hidden">
            <Navbar/>
            <div className="flex justify-center mt-5 text-5xl"><h1 className="text-white">Top Rated</h1></div>
